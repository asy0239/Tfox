...
<body>
	...
	<div id="mid1">
	<h3>
		<label id="userlist" style="font-size: x-large;font-weight: bold;">유저관리</label>
	</h3>
	<form>
		<table id="t1">
			<tr >
			...
			<tr>
			    ...
			    <td>
					...
					<input type="date" style="margin:20px">~<input type="date"></td>
			</tr>
			<tr>
			    <td>이메일 수신</td>
			    <td><input type="radio"  name="email" value="전체">전체
			    	<input type="radio" name="email" value="수신허용">수신허용
	...
	<!-- 검색 목록 -->
	<h3>
		<label id="userlist" style="font-size: x-large;font-weight: bold;">회원목록</label>
	</h3>
		<div>
			<form>
				<table id="t2">
